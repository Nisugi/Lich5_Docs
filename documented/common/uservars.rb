# Provides a namespace for the Lich project
# This module contains common functionality used throughout the project.
module Lich
  module Common
    ...
    #
    # Provides methods for managing user-specific variables
    # This module acts as a compatibility layer for variable management.
    # @example Accessing a user variable
    #   UserVars["my_var"] = "value"
    module UserVars
